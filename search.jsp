...
<!--This is a search page which helps user to search , add and edit the data in the system.
...
<form action="search.jsp" method="post" class="form-inline active-cyan-3 active-cyan-4">
