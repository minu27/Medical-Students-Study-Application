<!DOCTYPE html>
<!--This is a main page which is loaded after student logs in which shows 
the different categories to select from.
...
<h2 class="z-depth-2 center">Select Category</h2>
	...
	<form id="mForm" action="search.jsp" method="post">
